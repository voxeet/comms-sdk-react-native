...
public class RNVoxeetSDKVideoViewManager extends SimpleViewManager<VideoView> {
    ...
    private static final String REACT_CLASS = "RCTVoxeetSDKVideoView";
    private static final String TAG = RNVoxeetSDKVideoViewManager.class.getSimpleName();
    private EventDispatcher eventDispatcher;

    @NonNull
    @Override
    public String getName() {
        return RNVoxeetSDKVideoViewManager.REACT_CLASS;
    }
