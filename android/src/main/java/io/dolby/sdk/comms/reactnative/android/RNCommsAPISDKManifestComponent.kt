package io.dolby.sdk.comms.reactnative.android
...
import io.dolby.sdk.comms.reactnative.utils.IAPILog.log

class RNCommsAPISDKManifestComponent : AbstractManifestComponentProvider() {
  ...
  override fun getComponentName(): String =
    RNCommsAPISDKManifestComponent::class.java.simpleName

  override fun getDefaultAuthority(): String = "com.voxeet.reactnative.manifests."

  companion object {
    private val TAG = RNCommsAPISDKManifestComponent::class.java.simpleName
  }
