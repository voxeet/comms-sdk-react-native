...
import { Conference, ConferenceParticipantStatus, conferenceToMap, ParticipantInfo } from "./conference";
import {
  ConferencePermission,
  ParticipantInvited,
  Subscription,
  SubscriptionMapping } from "./notification";
import { ParticipantNotification } from "./notification/ParticipantNotification";
...
function transformIntoParticipantNotification(participant: any): ParticipantNotification {
  return {
    ...participant, //id, participantInfo
    status: ConferenceParticipantStatus[participant.status]
  }
}
